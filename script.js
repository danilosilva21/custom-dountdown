...
const conuntdownElTitle = document.getElementById('countdown-title');
const conuntdownBtn = document.getElementById('countdown-button');
...
conuntdownBtn.addEventListener('click', reset);
